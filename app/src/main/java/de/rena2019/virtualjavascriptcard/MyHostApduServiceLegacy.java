...
public class MyHostApduServiceLegacy extends HostApduService {
	...
	public byte[] processCommandApdu(byte[] apdu, Bundle extras) {
		...
		try {
			...
			Log.d(this.getClass().getName(), encodeHexString(apdu));
		...
		Log.d(this.getClass().getName(), encodeHexString(bytes));
		return bytes;
